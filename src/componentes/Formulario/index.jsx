  ...
  return (
    <Section>
      <form>
        ...
        <CampoTexto label="Clã" placeholder="Digite seu clã" />
        <CampoTexto label="Imagem" placeholder="Cole o endereço da imagem" />
        <ListaSuspensa label="Esporte" itens={esportes} />
      </form>
    </Section>
  );
};
